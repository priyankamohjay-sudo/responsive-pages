                ...
                child: SlideTransition(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Spacing before navigation buttons
                      SizedBox(height: screenWidth < 1000 ? 20 : screenWidth < 1200 ? 25 : 30),
    ...
    return SizedBox(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, slideIndex) {
          ...
          int endIndex = (startIndex + cardsPerSlide).clamp(0, testingTools.length);
