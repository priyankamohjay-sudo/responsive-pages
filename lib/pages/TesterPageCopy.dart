...
class TesterPagesCopy extends StatefulWidget {
  const TesterPagesCopy({super.key});

  @override
  _TesterPagesCopyState createState() => _TesterPagesCopyState();
}

class _TesterPagesCopyState extends State<TesterPagesCopy>
    with TickerProviderStateMixin {
  String _selectedLanguage = '';
  final List<Map<String, dynamic>> testingTools = [
    {'name': 'Selenium', 'icon': Icons.web, 'color': Color(0xFF43B02A)},
    {'name': 'JUnit', 'icon': Icons.check_circle, 'color': Color(0xFFED8B00)},
    {'name': 'Postman', 'icon': Icons.api, 'color': Color(0xFFFF6C37)},
    {'name': 'JIRA', 'icon': Icons.bug_report, 'color': Color(0xFF0052CC)},
    {'name': 'Bugzilla', 'icon': Icons.search, 'color': Color(0xFFCC0000)},
  ];
                  ...
                  child: FadeTransition(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Enhanced Testing tools buttons with icons
                        Expanded(
                          child: ListView.builder(
                            itemCount: testingTools.length,
                            itemBuilder: (context, index) {
                              final tool = testingTools[index];
                              final isSelected =
